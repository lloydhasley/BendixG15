...
class g15d_PN:
    ...
    def write_old(self, late_bus, word_time):
        if (word_time % 2) == 0:
    ...
    def add(self, late_bus, word_time):
        if self.cpu.instruction['time_end'] == self.cpu.instruction['time_start']:
            # single precision add, at even word time.
        ...
        # if (pn_new == 1) and ((late_bus_extended >> 57) == 0):  # mimic Verilog bug,  allows -0 to slip into PN
