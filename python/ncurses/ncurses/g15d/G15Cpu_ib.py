...
class g15d_ib:
    ...
    def intermediate_bus(self, early_bus, instruction):
        ...
        ip_pn_tr_pn_IP = Ts and self.cpu.flop_ip and ip_block_d and (instruction['s'] == PN) and \
                         ((instruction['ch'] & 2) == 0) and (instruction['d'] == PN)
        ...
        if self.cpu.verbosity & G15Cpu.VERBOSITY_CPU_INTERMEDIATE_BUS:
            ...
            print('ip_pn_tr_pn_IP=', ip_pn_tr_pn_IP)
        ...
        if Ts:
            ...
            # PG Clear
            ch = instruction['ch'] & 3
            if (instruction['s'] == 23) and (instruction['d'] == SPECIAL and ch == 0):
                self.cpu.flop_ip = 0
            ...
            # print("dp, odd word time, is=", self.cpu.flop_is, " ic=", self.cpu.flop_ic)
