...
class G15Curses:
    def __init__(self, debug):
        ...
        # create screen, status bar
        # and address for error messages
        self.screens  = self.curses_init()

        self.display_status("STATUS TEST")
        self.display_message("Welcome to the Bendix G15 Emulator")
        self.display_typeout("typeout TEST")
...
#        curses.nointr()            # remove ^C exit
        curses.raw()                # disable cooked & ^C
#        curses.cbreak()             # do not wait for character
