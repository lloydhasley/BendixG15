    ...
    def d31_special(self, instruction):
        ...
        if instruction['s'] == 0:
            ...
            if instruction['ch'] == 4 and instruction['s'] == 9 and (loc + 5) == instruction['t']:
                ...
                self.d31_special_print('print line 19 in numeric mode - need to add', g15d_d31.SPRINT_DONE)
            ...
            if instruction['ch'] == 0 and (loc + 2) == instruction['t']:
                ...
                self.d31_special_print('punch line 19 to paper tape', g15d_d31.SPRINT_DONE)
                return
            ...
            if instruction['ch'] == 0 and (loc + 2) == instruction['t']:
                ...
                self.d31_special_print('computer halt', g15d_d31.SPRINT_DONE)
                return

        elif instruction['s'] == 17:
            # if instruction['ch'] == 0 and (loc + 1) == instruction['t']:
            if instruction['ch'] == 0:
                #
                # RING BELL
                #
            ...
            #
            # print 'mark time: ', self.cpu.mark_time
            ...
            if instruction['ch'] == 0:
                ...
                t = instruction['t']
                word_at_t_time = self.g15.drum.read(02, t)

                print 'check if 2word read/writes needed here'

                # reg_id = self.g15.drum.read(ID, t)
                reg_pn = self.g15.drum.read(PN, t)

                reg_id = reg_pn & word_at_t_time
                reg_pn &= ~word_at_t_time

                self.g15.drum.write_two_word(ID, t, reg_id)  # double word write
                self.g15.drum.write_two_word(PN, t, reg_pn)

                return

        elif instruction['s'] == 24:
            # if instruction['t'] == 56 and instruction['ch'] == 0 and (loc % 2) == 1:
            #
            # multiply
            #
            self.multiply()
            ...
            # if instruction['t'] == 57 and instruction['ch'] == 1 and ((instruction['t'] % 2) == 1):
            if True:
                #
                # divide
                #
