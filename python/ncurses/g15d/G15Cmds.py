...
#                print line
    ...
    def process_command(self, line):
        ...
        # before we an execute command, we need to stop the CPU
    ...
    def cmd_set(self, args):
        ...
        if ll == 1:
            ...
            print 'dir=', self.syms
            for var, value in self.syms.iteritems():
    ...
    def cmd_verbosity(self, args):
        ...
        if ll == 1:
            for block_name, handle in known_blocks.iteritems():
        ...
        for block, handle in known_blocks.iteritems():
