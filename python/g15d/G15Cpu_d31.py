...
#                    self.g15.drum.write(19, i, 0)
    ...
    def ReturnToMarkOld(self, instruction):
        instruction['next_cmd_line'] = instruction['ch']
        ...
        if L2 == N:
            instruction['next_cmd_word_time'] = instruction['n']
        elif L2 <= N and N <= Mark:
            instruction['next_cmd_word_time'] = instruction['n']
        else:        
            instruction['next_cmd_word_time'] = Mark

        print("RTM: next_cmd_word_time=", instruction['next_cmd_word_time'])

    def ReturnToMarkold1(self, instruction):
        instruction['next_cmd_line'] = instruction['ch']
    ...
    def GoToMark(self, instruction):
        ...
        print("MARK set: ", self.cpu.mark_time)
