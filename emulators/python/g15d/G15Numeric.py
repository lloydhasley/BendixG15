...
class G15Numeric:
    ...
    def __init__(self, emulator, tracefile, tapename=None, signenable=0):
        self.emul = emulator
        ...
        gl.logprint('Building the Numeric G15...')

        # G15 consists of a cpu, memory (drum) and an IO sub-system
        self.cpu = G15Cpu.G15Cpu(self, 0, self.tracefile, self.signenable)
